...
from scripts.new_parser_library.Logger import Logger
from scripts.new_parser_library.internal_utils import *
from scripts.new_parser_library.internal_exceptions import JsonValidationError, JsonValidationWarning, JsonDuplicationWarning
from scripts.new_parser_library.Updater import ProgressBar, Counter

class Validator:
	def __init__(self, config=None):

		# Load/Cache schema definitions into memory
		schema_directory ='scripts/new_parser_library/schemas/'
