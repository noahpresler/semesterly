	...
	render: function() {
		...
		(React.createElement("div", null, 
			...
			React.createElement("div", {className: "copy-content"}, 
				...
				value: this.getShareLink(), readOnly: true})
			)
		)) :
		null;
		return (
