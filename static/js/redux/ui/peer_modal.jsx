...
export class PeerModal extends React.Component {
    ...
    render() {
        ...
        let sideSlots = this.props.liveTimetableCourses.map(c => {
            ...
            return (
                <div className="pm-side-bar-slot" style={ {backgroundColor: COLOUR_DATA[colourIndex].background}}
                     key={c.id}>
        ...
        let emptyState =
            <div className="peer-card upsell">
                <div className="peer-card-wrapper upsell cf">
                    ...
                    <p className="description">Seems you are the first one here! Add some more classes to your timetable
                        or check back later to find peers who have added the same classes as you!</p>
                </div>
            </div>
        ...
        let upsell =
            <div className="peer-card upsell">
                <div className="peer-card-wrapper upsell cf">
                    ...
                    <p className="description">See who your classmates are this semester! Click below to find
                        Semester.ly users in your courses, message them, or add them on Facebook! <i>By accepting this
                            permission, any Semester.ly students in your courses will be able to view your name and
            ...
            let sharedCourses = p.shared_courses.map(sc => {
                ...
                return (<div className="shared-course" key={String(sc.course.id) + p.profile_url}>
                    <div className="course-color-circle"
                         style={{backgroundColor: COLOUR_DATA[colourIndex].background}}>{inSection}</div>
                    ...
                    <div className="card-hat">
                        ...
                        <div className="user-info">
                            ...
                            <a href={p.profile_url} target="_blank">
                                <button className="view-profile-btn"><i className="fa fa-facebook-square"></i>View
                                    Profile
                                </button>
                            </a>
                            {isFriend}
        ...
        let ghostCards = !this.props.userInfo.social_all || peerCards.length == 0 ?
                ...
                <div id="pm-header">
                    ...
                    <div className="key">
                        <div className="key-entry">
                            <div className="course-color-circle" style={{backgroundColor: '#ddd'}}><i
