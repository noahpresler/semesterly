...
class AdvisingMasterSlot extends React.Component {
	constructor(props) {
		super(props);
...
AdvisingMasterSlot.defaultProps = {
	inModal: false,
	fakeFriends: 0,
...
export default AdvisingMasterSlot;
