...
class SearchBar extends React.Component {
  ...
  render() {
    ...
    return (
      <div className={classNames('search-bar no-print', { results: this.props.searchResults.length > 0 && this.state.focused })} >
        <div className="search-bar__wrapper">
          ...
          <div className="search-bar__input-wrapper" >
            <input
              ...
              className={classNames(this.props.isFetching ? 'results-loading-gif' : '')}
