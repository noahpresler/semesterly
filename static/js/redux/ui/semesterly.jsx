...
class Semesterly extends React.Component {
    ...
    render() {
        ...
        let cal = mobile && $(window).width() < 767 && this.state.orientation == 'portrait' ? <DayCalendarContainer /> :
            <CalendarContainer />;
        return (
            <div id="page-wrapper">
                <TopBarContainer />
                    ...
                    <div id="main-bar">
                        ...
                        <footer className="footer navbar no-print">
                            <ul className="nav nav-pills no-print">
                                ...
                                <li className="footer-button" role="presentation"><a target="_blank"
                                                                                     href="http://goo.gl/forms/YSltU2YI54PC9sXw1">Feedback</a>
                                </li>
                                <li className="footer-button" role="presentation"><a target="_blank"
                                                                                     href="https://www.facebook.com/semesterly/">Facebook</a>
                                </li>
                                <li className="footer-button">
                                    <div className="fb-like" data-href="https://www.facebook.com/semesterly/"
