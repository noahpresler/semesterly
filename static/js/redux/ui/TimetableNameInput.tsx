...
const TimetableNameInput = () => {
  ...
  const { activeTimetable, upToDate } = useSelector((state: RootState) => state.savingTimetable);
  ...
  const alterTimetableName = (event: { target: { value: React.SetStateAction<string>; }; }) => {
