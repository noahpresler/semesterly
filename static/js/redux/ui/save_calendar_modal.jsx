...
export class SaveCalendarModal extends React.Component {
	...
	render() {
        ...
        let UploadIcon = <img className="google-logo" src="https://a0.muscache.com/airbnb/static/signinup/google_icon_2x-745c2280e5004d4c90e3ca4e60e3f677.png" />;
                ...
                <div id="save-calendar-container">
                    <button className="btn abnb-btn" onClick={() => {
                            if (!this.props.userInfo.isLoggedIn || !this.props.userInfo.GoogleSignedUp || !this.props.userInfo.GoogleLoggedIn) {
                                ...
                                link.href = '/login/google-oauth2?next=' + location.protocol + "//" + location.host + "/callback/google_calendar"
