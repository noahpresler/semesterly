...
class Alert extends React.Component {
     ...
     */
    _showIcon() {
        let icon = this.props.icon || <div className={this.props.type + '-icon'}/>;
        return icon;
    }
    ...
    render() {
        return (
            <div style={this.props.style.alert}
                ...
                <div onClick={this._handleCloseClick.bind(this)} style={this.state.closeButtonStyle}
