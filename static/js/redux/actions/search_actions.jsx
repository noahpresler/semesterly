...
import { alertsActions, advancedSearchModalActions } from "../state/slices";
...
export const fetchAdvancedSearchResults =
  ...
  (dispatch, getState) => {
    ...
    dispatch(advancedSearchModalActions.requestAdvancedSearchResults());
...
export const setAdvancedSearchResultIndex = (idx, courseId) => (dispatch) => {
  dispatch(advancedSearchModalActions.setActiveAdvancedSearchResult(idx));
