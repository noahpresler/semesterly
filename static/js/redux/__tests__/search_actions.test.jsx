...
describe('maybeSetSemester', () => {
  // TODO: add back after finished normalizing timetable state
  ...
  //     rootReducer,
  //     { userInfo: loggedIn, timetables: withTimetables, semester: sampleSemesters },
  ...
  //     .reply(201, {
  //       saved_timetable: emptyTimetable,
  ...
  //   const store = createStore(
  //     rootReducer,
  //     { semester: sampleSemesters, timetables: withTimetables },
  //     applyMiddleware(thunkMiddleware),
  //   );
  //   store.dispatch(maybeSetSemester(1));
