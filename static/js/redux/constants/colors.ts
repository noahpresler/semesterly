...
import { SlotColorData } from "./commonTypes";

export const lightSlotColor: SlotColorData[] = [
  // red
...
export const darkSlotColor: SlotColorData[] = [
  // red
  { background: "#F16E66", highlight: "#e36867", border: "#b15150", font: "#222" },
  // blue
  { background: "#5598DF", highlight: "#52b7d9", border: "#408ea9", font: "#222" },
  // turquoise
  { background: "#57C3B9", highlight: "#30c7a8", border: "#259b82", font: "#222" },
  // 'yellow'
  { background: "#F2B25C", highlight: "#e5be58", border: "#b29444", font: "#222" },
  // purple
  { background: "#7C72DC", highlight: "#b177c7", border: "#895d9b", font: "#222" },
  // green
  { background: "#59BEA0", highlight: "#4ad187", border: "#3aa369", font: "#222" },
  { background: "#D4DBC8", highlight: "#B5BFA3", border: "#97A086", font: "#222" },
  { background: "#E7F76D", highlight: "#C9E20A", border: "#AFC11F", font: "#222" },
  { background: "#A3F5F2", highlight: "#7CD2CF", border: "#53ABA8", font: "#222" },
  { background: "#7499A2", highlight: "#668B94", border: "#6C7A89", font: "#222" },
