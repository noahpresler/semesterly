...
export const darkSlotColor: SlotColorData[] = [
  ...
  { background: "#F3863D", highlight: "#da7836", border: "#aa5d2a", font: "#222" },
  { background: "#9E81B6", highlight: "#8e74a3", border: "#6e5a7f", font: "#222" },
  { background: "#54C1E3", highlight: "#4badcc", border: "#3a879e", font: "#222" },
  { background: "#7499A2", highlight: "#668B94", border: "#6C7A89", font: "#222" },
