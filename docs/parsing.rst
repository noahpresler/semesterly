...
.. note:: To parse JHU data, you will need to acquire an API access key from `sis.jhu.edu/api <sis.jhu.edu/api>`_. Add the key to ``dev_credentials.py`` in the ``semesterly/`` directory.
