...
Explanation:
    ...
    :type: indicates json object of type "course"
    ...
    :department: is a dictionary that contains the department code and name. One of these sub-fields (code or name) is required, but both are preferred. Note that all entries per school must at least be consistent in the definition of one of these terms in all courses.
    ...
    :extra: preferably should be excluded but may contain special cases of information that cannot be expressed within this format.
...
Explanation:
    ...
    :type: indicates json object of type "section"
...
Explanation:
    ...
    :type: indicates json object of type "textbook link".
    :course: the course that the textbook link applies to.
    :section: the section that the textbook link applies to.
    :isbn: isbn of textbook to link to.
    :required: a bool indicated whether a textbook is required for a section or not.
...
Explanation:
    ...
    :type: indicates json object of type "textbook"
...
Explanation:
    ...
    :type: indicates json object of type "eval"(uation)
