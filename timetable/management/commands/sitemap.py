...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        xml += (
            "<url><loc>https://semester.ly</loc><lastmod>"
            + update_time
            + "</lastmod><changefreq>daily</changefreq><priority>0.1</priority></url>\n"
        )
        xml_footer = "</urlset>"
        ...
        for school in ACTIVE_SCHOOLS:
            ...
            xml += (
                "<url><loc>https://"
                + school
                + ".semester.ly/courses</loc><lastmod>"
                + update_time
                + "</lastmod><changefreq>daily</changefreq><priority>0.1</priority></url>\n"
            )
