...
SOCIAL_AUTH_AZURE_TENANT_KEY = get_secret('SOCIAL_AUTH_AZURE_TENANT_KEY')
SOCIAL_AUTH_AZURE_TENANT_SECRET = get_secret('SOCIAL_AUTH_AZURE_TENANT_SECRET')
SOCIAL_AUTH_AZURE_TENANT_ID = get_secret('SOCIAL_AUTH_AZURE_TENANT_ID')
